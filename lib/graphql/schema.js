...
const contextlink = setContext((_, previousContext) => {
  ...
  if (req.headers.cookie) {
    ...
    if (customCookie) {
      console.log('customCookie at contextLink', customCookie);
      token = customCookie;
    }
  }
...
// console.log({
//   remoteExecutableSchema: remoteExecutableSchema._typeMap,
//   transformedRemoteSchema: transformedRemoteSchema._typeMap,
//   schema: schema._typeMap,
// });
