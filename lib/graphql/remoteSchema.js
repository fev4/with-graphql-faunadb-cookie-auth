// To get this file go to https://dashboard.fauna.com
// Select your database
// Go to "Graphql"
// Click on "Schema" (right side)
// Then download in SDL format
// Then when you paste it be careful with backtics (`) as it messes the template literal
