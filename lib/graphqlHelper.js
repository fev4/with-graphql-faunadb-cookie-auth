    ...
    .catch((error) => {
      if (fieldName !== 'logoutUser') {
        ...
        if (error.message === 'Invalid database secret.') {
          console.log(
            '   mutation logoutUser -- Already logged out -- Deleting cookie'
          );
        ...
        if (
          ...
          console.log(
            '   mutation logoutUser -- Already logged out and using public token'
          );
          return 'already logged out';
        }
        console.log(
          "   mutation logoutUser -- Couldn't log user out --",
          error.message
        );
